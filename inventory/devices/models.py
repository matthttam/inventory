...
# from googlesync.models import GoogleDeviceSyncProfile
...
class Device(models.Model):
    ...
    google_sync_profile = models.ForeignKey(
        "googlesync.GoogleDeviceSyncProfile",
...
class DeviceModel(models.Model):
    ...
    manufacturer = models.ForeignKey(
        "DeviceManufacturer", on_delete=models.CASCADE, blank=True, null=True
    )
